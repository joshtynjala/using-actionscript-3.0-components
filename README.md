# Using ActionScript 3.0 Components (Flash Pro CS5)

An archive containing the contents of _Using ActionScript 3.0 Components_ from
the _Adobe Flash Professional CS5_ documentation, by Adobe Systems Incorporated.
The full text of this documentation has been converted to Markdown, for ease of
readability and to provide an easy base for transforming the content into other
formats.
